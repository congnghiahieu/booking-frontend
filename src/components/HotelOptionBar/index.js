    ...
    <div className={style.hotel_option}>
      <div className={style.hotel_optionbar}>
        <div className={style.hotel_selectoption}>
          <a href="#Overview" className={style.hotel_select}>Tổng quan</a>
          <a href="#hotelSuggest" className={style.hotel_select}>Phòng nghỉ</a>
          <a className={style.hotel_select}>Tiện ích</a>
          <a href="#hotelCmt" className={style.hotel_select}>Đánh giá</a>
