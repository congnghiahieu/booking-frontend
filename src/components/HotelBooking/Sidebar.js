            ...
            <div className={style.Sidebar}>
                <div className={style.card}>
                    <div className={style.info}>
                        ...
                        <div className={style.cardBody}>
                            ...
                            <p className={style.cardText}>{hotel.address}</p>
                        </div>
                    </div>
                ...
                <div className={style.card}>
                    ...
                    <div className={style.feedBack}>
                        ...
                        <div className={style.comment}>
                            ...
                            <p id={style.two}>Từ {hotel.numOfComments} bài viết</p>
                        </div>
                    </div>
                    <hr />
                    <div className={style.info}>
                ...
                <div className={style.card}>
                    <div className={style.bookingInfo}>
                        <span>GIẢM {hotel.discount} HÔM NAY</span>
                        <div>
                            <div className={style.priceSection}>
                                <p>Giá gốc:</p>
                                <p style={{ textDecoration: 'line-through' }}>{hotel.orginalPrice}</p>
                            </div>
                            <div className={style.priceSection}>
                                <p>Giá ưu đãi:</p>
                                <p>{hotel.discountPrice}</p>
                            </div>
                            <div className={style.priceSection}>
                                <p>Phí đặt trước:</p>
