...
import { faUser, faCalendarCheck, faMessage, faCircleCheck } from "@fortawesome/free-solid-svg-icons"
              ...
              <div className={style.booking}>
                ...
                <div className={style.info}>
                  ...
                  <div className={style.state}>
                    <FontAwesomeIcon icon={faCircleCheck} style={{ color: "#28871c", }} />  Thanh toán thành công
                  </div>
