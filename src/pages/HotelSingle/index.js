            ...
            <div className={style.hotel_name}>
              ...
              <div className={style.hotel_text}>
                <div className={style.hotel_header}>
                  <p>Căn hộ Nikko - Cuộc sống quý phái (Nikko Apartments - The Classy Life)</p>
                  <span className={style.hotel_star}></span>
                </div>

                <p className={style.hotel_location}>Quận 7, Hồ Chí Minh, Việt Nam</p>
                <p className={style.hotel_decription}>
                  Hãy để chuyến đi của quý khách có một khởi đầu tuyệt vời khi ở lại khách sạn này,
                  nơi có Wi-Fi miễn phí trong tất cả các phòng. Nằm ở vị trí trung tâm tại Quận 7
                  của Hồ Chí Minh, chỗ nghỉ này đặt quý khách ở gần các điểm thu hút và tùy chọn ăn
                  uống thú vị. Đừng rời đi trước khi ghé thăm Bảo tàng Chứng tích chiến tranh nổi
                  tiếng. Chỗ nghỉ 5 sao này được trang bị các tiện nghi ngay trong khuôn viên để
            ...
            <div className={style.hotel_nearby}>
              <div className={style.feedback_position}>
                <div className={style.hotel_point1}>
                  <span className={style.hotel_point}>9,2 Trên cả tuyệt vời</span>
